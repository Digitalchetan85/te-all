            ...
            <Col md={8}>
                ...
                <Row>
                  ...
                  <Col md={4} className="align-self-center">
                    <div className="text-center py-2">
                      <h2 className="fs-4 text-center">₹ 3.06Cr* Onwards</h2>
                      <Button
                        variant="primary"
                        onClick={handleShow}
              ...
              <div className="p-3 bg-white my-2">
                <Row>
                  ...
                  <Col md={4} className="align-self-center">
                    <div className="text-center py-2">
                      <h2 className="fs-4 text-center">₹ 6.4Cr* Onwards</h2>
                      <Button
                        variant="primary"
                        onClick={handleShow}
                        className="w-100 mt-2 text-uppercase"
              ...
              <div className="p-3 bg-white my-2">
                <Row>
                  ...
                  <Col md={4} className="align-self-center">
                    <div className="text-center py-2">
                      <h2 className="fs-4 text-center">₹ 5.17Cr* Onwards</h2>
                      <Button
                        variant="primary"
                        onClick={handleShow}
                        className="w-100 mt-2 text-uppercase"
              ...
              <div className="p-3 bg-white my-2">
                <Row>
                  ...
                  <Col md={4}>
                    <div className="text-center text-md-start py-2">
                      <a href="/" className="text-decoration-none text-dark">
                        <h2 className="fs-5 w-100">Workcations - Whitefield</h2>
                      </a>
                      <div className="pb-2">
                  ...
                  <Col md={4} className="align-self-center">
                    <div className="text-center py-2">
                      <h2 className="fs-4 text-center">Price On Request</h2>
                      <Button
                        variant="primary"
                        onClick={handleShow}
                        className="w-100 mt-2 text-uppercase"
              ...
              <div className="p-3 bg-white my-2">
                <Row>
                  ...
                  <Col md={4}>
                    <div className="text-center text-md-start py-2">
                      <a href="/" className="text-decoration-none text-dark">
                        <h2 className="fs-5 w-100">Workcations - Yelhanka</h2>
                      </a>
                      <div className="pb-2">
                        <span className="badge bg-primary">Workations</span>
                      </div>
