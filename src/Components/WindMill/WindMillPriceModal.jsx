...
const WindMillPriceModal = (props) => {
                      ...
                      >
                        ...
                        >
                          ...
                          <div className="text-center my-3">
                            <Button
                              variant="new"
                              className="w-100 btn btn-primary text-uppercase fw-bolder border-0 px-3"
                              type="submit"
                            >
...
export default WindMillPriceModal;
