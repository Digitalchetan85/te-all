...
const MagicFarawayPriceModal = (props) => {
  ...
  const onSubmit = (data) => {
    ...
    let sendingdata = {
      ...
      firstname: data.name,
      lastname: "",
      source: "Total Enviroment - Magic Faraway Tree",
...
export default MagicFarawayPriceModal;
