      ...
      <div className="container">
        ...
        <div className="">
          ...
          <p>
            ...
            the cookies of this website by changing the settings of your
            browser.
          </p>

          <p>
            The personal information provided by the users to us will not be
            provided to third parties without the previous consent of the user
            concerned. Information of a general nature may however be revealed
            to external parties.
          </p>
          ...
          <p>
            ...
            is not mandatory. You are solely responsible for maintaining the
          ...
          <p>
            ...
            its marketing and promotional efforts, to analyze site usage,
            improve the Site’s content and product offerings, and customize the
            Site’s content, layout, and services. These uses improve the Site
            and better tailor it to meet your needs, so as to provide you with a
            smooth, efficient, safe, and customized experience while using the
            Site.
          </p>
          ...
          <p>
            ...
            You may make changes to your profile at any time. we believes that
            the privacy of a person can be best guaranteed by working in
            conjunction with the Law enforcement authorities.
          </p>

          <p>
            All websites including this website fully comply with all Indian
            Laws applicable. We has always cooperated with all law enforcement
            inquires. We may disclose all or part of your personal details in
          ...
          <p>
            We has taken all reasonable steps to ensure that information on this
            site is authentic. Users are advised to research bonafides of
            advertisers independently. We shall not have any responsibility in
            this regard. We also recommend that you visit the link to User
            agreement/Disclaimer for more comprehensive information on this
            aspect.
          </p>
        </div>
      </div>
