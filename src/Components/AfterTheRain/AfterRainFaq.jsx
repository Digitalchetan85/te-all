      ...
      <Row>
        <Col md={12}>
          ...
          <h2 className="text-center py-md-3 py-2 text-info fs-3 d-none d-md-block">
            Total Environment After The Rain - FAQs
          </h2>
        </Col>
      </Row>

      <div id="rainfaq" className="py-3 py-md-5">
        <Container>
          <Row>
            <Col md={12}>
              <div class="accordion accordion-flush" id="accordionFlushExample">
                <div class="accordion-item">
                  <h2 class="accordion-header" id="flush-headingOne">
                    ...
                    >
                      Total Environment After the Rain Configuration in Project?
                    </button>
                  </h2>
                  <div
                ...
                <div class="accordion-item">
                  <h2 class="accordion-header" id="flush-headingTwo">
                    ...
                    >
                      What is the price of a 3 BHK Villa in Total Environment
                      After the Rain?
                    </button>
                  </h2>
                  <div
                ...
                <div class="accordion-item">
                  <h2 class="accordion-header" id="flush-headingThree">
                    ...
                    >
                      Where is Total environment After the Rain located in North
                      Bangalore?
                    </button>
                  </h2>
                  <div
                ...
                <div class="accordion-item">
                  <h2 class="accordion-header" id="flush-headingFour">
                    ...
                    >
                      WHAT IS THE TOTAL LAND AREA OF Total environment After the
                      Rain?
                    </button>
                  </h2>
                  <div
                ...
                <div class="accordion-item">
                  <h2 class="accordion-header" id="flush-headingFive">
                    ...
                    >
                      WHAT ARE THE KEY AMENITIES AT Total environment After the
                      Rain?
                    </button>
                  </h2>
                  <div
                  ...
                  >
                    <div class="accordion-body">
                      ...
                      Table Tennis Toddlers' Pool and much more.
                    </div>
                  </div>
                </div>
                <div class="accordion-item">
                  <h2 class="accordion-header" id="flush-headingSix">
                    ...
                    >
                     WHAT IS THE Possession Time for Total environment After the Rain?
                    </button>
                  </h2>
                  <div
